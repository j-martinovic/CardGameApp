...
var require_diff = __commonJS({
  "node_modules/rfc6902/diff.js"(exports) {
    ...
    function intersection2(a2, b2) {
      var keys = [];
      for (var key in a2) {
        if (util_1.hasOwnProperty.call(a2, key) && a2[key] !== void 0 && util_1.hasOwnProperty.call(b2, key) && b2[key] !== void 0) {
          keys.push(key);
        }
      }
      return keys;
...
var require_patch = __commonJS({
  "node_modules/rfc6902/patch.js"(exports) {
    ...
    function copy2(object, operation, options) {
      var from_endpoint = pointer_1.Pointer.fromJSON(operation.from).evaluate(object);
      if (from_endpoint.value === void 0) {
        return new MissingError(operation.from);
      }
    ...
    function apply(object, operation, options) {
      switch (operation.op) {
        ...
        case "copy":
          return copy2(object, operation, options);
        case "test":
...
var require_rfc6902 = __commonJS({
  "node_modules/rfc6902/index.js"(exports) {
    ...
    var diff_1 = require_diff();
    function applyPatch2(object, patch2, options) {
...
//# sourceMappingURL=chunk-DWAPLB2Q.js.map
